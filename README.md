...
# staging.cloudposse.co [![Codefresh Build Status](https://g.codefresh.io/api/badges/build?repoOwner=cloudposse&repoName=staging.cloudposse.co&branch=master&pipelineName=staging.cloudposse.co&accountName=cloudposse&type=cf-1)](https://g.codefresh.io/pipelines/staging.cloudposse.co/builds) [![Latest Release](https://img.shields.io/github/release/cloudposse/staging.cloudposse.co.svg)](https://github.com/cloudposse/staging.cloudposse.co/releases) [![Slack Community](https://slack.cloudposse.com/badge.svg)](https://slack.cloudposse.com)
...
File a GitHub [issue](https://github.com/cloudposse/staging.cloudposse.co/issues), send us an [email][email] or join our [Slack Community][slack].
...
Please use the [issue tracker](https://github.com/cloudposse/staging.cloudposse.co/issues) to report any bugs or file feature requests.
